...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, help='Env Name', default='CartPole-v1')
    ...
    model_constructor = CategoricalPolicy(env_constructor.state_dim, env_constructor.action_dim, args.hidden_size)

    ai = ERL_Trainer(args, env_constructor)
