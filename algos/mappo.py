...
from algos.single_agent.utils_common import to_tensor_var, index_to_one_hot
...
class MAPPO:
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        self.memory = OnPolicyReplayMemory(200)
    ...
    def train(self, Max_EPISODES):
        ...
        for gen in range(1, Max_EPISODES + 1):
            ...
            if gen % 5 == 0:
                ...
                rewards, (vehicle_speed, vehicle_position), steps, avg_speeds = self.evaluation(self.actor,
                                                                                                self.env)
        ...
        np.save(r'../Results/eval_rewards_mappo_test.npy', eval_rewards)
        ###Kill all processes
        try:
        ...
        for i in range(eval_episodes):
            ...
            if is_train:
                if self.traffic_density == 1:
                    ...
                    state, action_mask = env.reset(is_training=False, testing_seeds=111, num_CAV=i + 4)
            else:
